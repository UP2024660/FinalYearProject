class GraphVisualization {
    ...
    init() {
      ...
      document.querySelector('#downloadsvg').addEventListener('click', this.downloadSVG);
      document.querySelector('#downloadjson').addEventListener('click', this.downloadJSON);
...
window.addEventListener('load',graphViz.init)